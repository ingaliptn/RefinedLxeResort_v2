...
//Swiper Slider Carousel Scritps
		var swiper = new Swiper('.Swiper_PixaSlider',{
			speed: 1000,
			autoplay: true,
			parallax: true,
			mousewheel: true,
			...
			// If we need swiper vertical scroll
			//direction: 'vertical',
		...
		var swiper = new Swiper('.Swiper_SingleSlider',{
			speed: 1000,
			delay: 10000,
			autoplay: true,
			parallax: true,
		...
		var swiper = new Swiper('.Swiper_sliderSection',{
			speed: 3000,
			autoplay: true,
			parallax: true,
			mousewheel: false,
		...
		var swiper = new Swiper('.Swiper_CategoryPageSlider, .Swiper_SubCategoryPageSlider',{
			speed: 1000,
			autoplay: true,
			parallax: true,
			mousewheel: false,
		...
		var galleryThumbs = new Swiper('.swiperGallery_Thumbs', {
		  spaceBetween: 10,
		  slidesPerView: 4,
		  freeMode: true,
		...
		var galleryTop = new Swiper('.Swiper_SingleSlider_Gallery',{
			speed: 1000,
			autoplay: false,
			parallax: true,
			//mousewheel: true,
		...
		var swiper = new Swiper('.Swiper_PixaCarousel',{
			speed: 1000,
			autoplay: false,
			parallax: true,
			mousewheel: false,
		...
		var swiper = new Swiper('.Swiper_ProductSectionCarousel',{
			speed: 1000,
			autoplay: false,
			parallax: true,
			mousewheel: false,
		...
		var swiper = new Swiper('.Swiper_PixaCarouselCoverFlow',{
			speed: 1000,
			autoplay: true,
			parallax: true,
			//mousewheel: true,
		...
		//Brand Logo
		var swiper = new Swiper('.Swiper_BrandLogoCarousel',{
			speed: 1000,
			autoplay: true,
			parallax: true,
			//mousewheel: true,
		...
		//Brand Logo
		var swiper = new Swiper('.Swiper_CategoryBrandLogo_Carousel',{
			speed: 1000,
			autoplay: true,
			parallax: true,
			//mousewheel: true,
		...
		//Brand Logo
		var swiper = new Swiper('.Swiper_NewsEventCarousel',{
			speed: 1000,
			autoplay: false,
			parallax: true,
			//mousewheel: true,
		...
		//Client Reviews
		var swiper = new Swiper('.swiper_clientReviews',{
			speed: 1000,
			autoplay: true,
			parallax: true,
			//mousewheel: true,
		...
		var swiper = new Swiper('.Swiper_Carousel_RightInfinite',{
			speed: 1000,
			autoplay: true,
			parallax: true,
			//mousewheel: true,
		...
		var swiper = new Swiper('.Swiper_Carousel_FullWidth',{
			speed: 1000,
			autoplay: false,
			parallax: true,
			//mousewheel: true,
